...
---
<section class="om-hero" style="min-height:0; padding: 4rem 2rem 1.5rem;">
...
<main>
  <div class="om-body">
    <div class="topic-grid">
      <a href="{{ site.baseurl }}/worksheets-number/" class="topic-card blue">
      ...
      <a href="{{ site.baseurl }}/worksheets-shape/" class="topic-card orange">
        <div class="card-bar"></div>
        <div class="card-body">
      ...
      <a href="{{ site.baseurl }}/worksheets-algebra/" class="topic-card green">
        <div class="card-bar"></div>
        <div class="card-body">
      ...
      <a href="{{ site.baseurl }}/worksheets-formulae/" class="topic-card purple">
        <div class="card-bar"></div>
        <div class="card-body">
      ...
      <a href="{{ site.baseurl }}/worksheets-times-tables/" class="topic-card blue">
        <div class="card-bar"></div>
        <div class="card-body">
      ...
      <a href="{{ site.baseurl }}/worksheets-support-sheets/" class="topic-card orange">
        <div class="card-bar"></div>
        <div class="card-body">
